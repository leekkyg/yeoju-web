...
export default function PostDetailClient({ post, ads }: PostDetailClientProps) {
  ...
  const livereHtml = `<livere-comment client-id="gSoyK4WDjal75heUDfIB" article-id="${post.id}"></livere-comment><script type="module" src="https://www.livere.org/livere-widget.js"><\/script>`;
        ...
        <main className="pb-8">
          ...
          {ads.length > 0 && isValidUrl(ads[0].image_url) && (
            <div className="mt-4 md:px-4">
              <Link
                href={ads[0].link_url || "#"}
                className="block md:rounded-xl md:overflow-hidden"
              >
                <OptimizedImage
                  src={ads[0].image_url}
                  alt={ads[0].title || ""}
              ...
              <p
                className="text-[10px] text-center mt-1 px-4"
                style={{ color: theme.textMuted }}
              >
                광고
              </p>
          ...
          <style jsx global>{`
            ...
            #livere-comments[data-theme="dark"] img,
            #livere-comments[data-theme="dark"] video,
            #livere-comments[data-theme="dark"] svg,
            #livere-comments[data-theme="dark"] iframe,
            #livere-comments[data-theme="dark"] [class*="avatar"],
            #livere-comments[data-theme="dark"] [class*="profile"],
            #livere-comments[data-theme="dark"] [style*="background-image"] {

    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <header className="bg-white sticky top-0 z-50 border-b border-gray-100">
        <div className="max-w-lg mx-auto px-4 h-14 flex items-center">
          ...
          <h1 className="font-bold text-lg text-gray-900">영상</h1>
        </div>
      </header>
              ...
              >
                <div className="relative aspect-video bg-gray-100">
                  {video.thumbnail_url ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-green-600 to-green-400 flex items-center justify-center">
                ...
                <div className="px-4 py-3">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    조회수 {formatViews(video.view_count || 0)}회
                  </p>
                </div>
              </Link>
            ))}
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
        <div className="max-w-lg mx-auto flex">
          ...
          <Link href="/videos" className="flex-1 py-3 flex flex-col items-center gap-1 text-green-600">
